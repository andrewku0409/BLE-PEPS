package com.uaes.ble_client_v0;
...
public class BluetoothLeClass{
    ...
    private OnConnectStatusChangedListener mOnConnectStatusChangedListener;
    ...
    public void setOnOnConnectStatusChangedListener(OnConnectStatusChangedListener l){
        mOnConnectStatusChangedListener = l;
    }
     ...
     * callback.
     *
     * param  The characteristic to read from.
     */
    ...
    public BluetoothGattService getService(UUID serUUID) {
        if (mBluetoothGatt == null) return null;

        return mBluetoothGatt.getService(serUUID);
    }
}
